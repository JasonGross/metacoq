...
Module qKernameSet <: MSetAVL.QuotationOfMake Kername KernameSet.
  ...
  Module qRaw.
    ...
    MetaCoq Run (Kernames_mp <- tmExtractBaseModPathFromMod "MetaCoq.Common.Kernames";; tmMakeQuotationOfModuleAndRebase false "Raw'" (MPdot (MPdot Kernames_mp "KernameSet") "Raw")).
  End qRaw.
  MetaCoq Run (Kernames_mp <- tmExtractBaseModPathFromMod "MetaCoq.Common.Kernames";; tmMakeQuotationOfModuleAndRebase false "KernameSet'" (MPdot Kernames_mp "KernameSet")).
End qKernameSet.
