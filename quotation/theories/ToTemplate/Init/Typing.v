...
From MetaCoq.Template Require Import MonadAst TemplateMonad Ast Loader Typing.
...
#[export] Instance well_typed_ground_quotable_of_bp {b P} (H : b = true -> P) {qH : quotation_of H} (H_for_safety : P -> b = true) {qP : quotation_of P} {Pcf : config.typing_restriction} {qtyH : quotation_of_well_typed H} : @ground_quotable_well_typed Pcf _ _ (@ground_quotable_of_bp b P H qH H_for_safety).
Proof.
